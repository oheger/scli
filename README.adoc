...
Before we come to practical examples in the Tutorial section, it can help to
get some understanding of the underlying concepts used by _SCLI_. So this
section presents a (short) theoretical introduction.
...
Now it is a good time to checkout the tutorial to see practical usage examples.
